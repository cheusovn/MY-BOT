...
AGENTS = [
    ...
    {
        "num": "02", "icon": "🔥", "name": "ОХОТНИК ЗА ТРЕНДАМИ",
    ...
    },
    {
        ...
        "prompt": (
            ...
            "Пример: «Твой SMM-щик стоит 60 000₽. Мой — 0₽.»"
        ),
        "result": "120+ хуков за месяц. Лучшие дали x3 к охватам.",
    },
    {
        "num": "05", "icon": "📅", "name": "ПЛАНИРОВЩИК",
    ...
    {
        "num": "06", "icon": "🎨", "name": "ДИЗАЙНЕР КАРУСЕЛЕЙ",
        "what": "Создаёт слайды карусели по референсу. 10 слайдов за 10 минут и 70 рублей.",
    ...
    {
        "num": "08", "icon": "🚀", "name": "ПУБЛИКАТОР",
        "what": "Публикует готовый контент одновременно в Instagram, Threads и Facebook по расписанию.",
        "tool": "SocialAPI + cron-расписание",
        "prompt": (
        ...
        "result": "Три площадки покрыты. Я не думаю когда публиковать.",
    },
]
...
def generate() -> str:
    ...
    for ag in AGENTS:
        ...
        pdf.set_xy(12, 26)
        pdf.multi_cell(186, 9, f"{ag['icon']} АГЕНТ {ag['num']}: {ag['name']}")
